...
logging.getLogger('mcp_instana.tools.infrastructure.infrastructure_metrics').addHandler(null_handler)
logging.getLogger('mcp_instana.tools.infrastructure.infrastructure_metrics').propagate = False
...
with patch('mcp_instana.utils.with_header_auth', mock_with_header_auth):
    ...
    with patch('mcp_instana.tools.infrastructure.infrastructure_metrics.GetCombinedMetrics', mock_combined_metrics):
        # Import the class to test
        from mcp_instana.tools.infrastructure.infrastructure_metrics import (
...
class TestInfrastructureMetricsMCPTools(unittest.TestCase):
    ...
    @patch('mcp_instana.tools.infrastructure.infrastructure_metrics.datetime')
