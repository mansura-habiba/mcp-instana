...
app_logger = logging.getLogger('mcp_instana.tools.infrastructure.infrastructure_resources')
app_logger.handlers = []
...
with patch('mcp_instana.utils.with_header_auth', mock_with_header_auth):
    ...
    from mcp_instana.tools.infrastructure.infrastructure_resources import (
